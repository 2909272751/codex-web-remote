...
2. 下载 `CodexWebRemote-Setup-1.4.5-win-x64.exe`。
3. 双击安装程序，按提示完成安装。
...
1. 下载 `CodexWebRemote-Portable-1.4.5-win-x64.zip`。
2. 完整解压到固定目录。
...
```powershell
.\scripts\installer-test.ps1 -SetupPath .\dist\CodexWebRemote-Setup-1.4.5-win-x64.exe
```
